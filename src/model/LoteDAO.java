...
public class LoteDAO {
    ...
    public void inserir(LoteEstoque lote, String nomeProduto, String urlImagem) throws SQLException {
        String sql = "INSERT INTO Lote (idFornecedor, nome, num_lote, quantidade, data_entrada, validade, alerta_min, url_imagem) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DataBase.getConnection();
            ...
            stmt.setString(8, urlImagem != null ? urlImagem : "med.png");
    ...
    public void atualizar(LoteEstoque lote, String nomeProduto, String urlImagem) throws SQLException {
        String sql = "UPDATE Lote SET idFornecedor = ?, nome = ?, num_lote = ?, quantidade = ?, " +
                "data_entrada = ?, validade = ?, alerta_min = ?, url_imagem = ? WHERE idLote = ?";
    ...
    public List<Object[]> listarTodosComNome() throws SQLException {
        ...
        try (Connection conn = DataBase.getConnection();
            ...
            while (rs.next()) {
                ...
                String urlImagem = rs.getString("url_imagem");

                lista.add(new Object[]{lote, nomeProduto, urlImagem});
            }
        }
