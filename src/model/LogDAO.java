...
public class LogDAO {
     ...
     * @param tipoOperacao - "CRIAR", "EDITAR", "EXCLUIR" ou null para todos
     * @param entidade - "LOTE", "FORNECEDOR" ou null para todos
     */
    ...
    /**
     * Lista logs de um período específico
     */
    ...
    /**
     * Busca logs por palavra-chave na descrição
     */
    ...
    /**
     * Exclui logs antigos (útil para manutenção)
     * @param diasAntigos - Remove logs com mais de X dias
     */
